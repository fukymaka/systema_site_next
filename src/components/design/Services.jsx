...
import { systemaWhiteSymbol, gradient, play } from "../../../public/assets";
...
export const PhotoChatMessage = () => {
  return (
    <div className="absolute top-8 left-4 max-w-[17.5rem] py-6 px-8 bg-black rounded-t-xl rounded-bl-xl font-code text-base lg:top-16 lg:right-[8.75rem] lg:max-w-[17.5rem]">
      Ну что, пора готовиться к экзаменам
